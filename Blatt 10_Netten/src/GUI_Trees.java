...
public class GUI_Trees extends JFrame {
	...
	private void insertNodeToAVLTree() {
		try {baum234.insertNode(Integer.parseInt(fldAVLInput.getText())); }
	...
	private void updateDrawPanel() {
		...
		drawPanel.update(gr);
		if (!baum234.isEmpty()) baum234.drawTTFTree(gr, drawPanel.getWidth()/2, Math.max(50, drawPanel.getHeight()/10));
	}
